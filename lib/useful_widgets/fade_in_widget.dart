...
class FadeInWidgetTeamImage extends StatefulWidget {
  final Widget child;

  const FadeInWidgetTeamImage({super.key, required this.child});

  @override
  State<FadeInWidgetTeamImage> createState() => _FadeInWidgetTeamImageState();
}

class _FadeInWidgetTeamImageState extends State<FadeInWidgetTeamImage>
    with TickerProviderStateMixin {
  late AnimationController _textController;
  late Animation<double> _textFadeAnimation;
  late Animation<Offset> _textSlideAnimation;
